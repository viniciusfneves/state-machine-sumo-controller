...
payload = {"controller":{"linearSpeed": 0, "angularSpeed": 0}}
...
def main():
    ...
    while True:
        ...
        payload["controller"]["linearSpeed"] = controller.linearSpeed
        payload["controller"]["angularSpeed"] = controller.angularSpeed
        ...
        if controller.Start == 1:
            ...
            payload["controller"]["linearSpeed"] = 0
            payload["controller"]["angularSpeed"] = 0
