...
int main(int argc, char **argv) {
  ...
  while (wb_robot_step(TIME_STEP) != -1) {
    ...
    printf("line[0]=%f | line[1]=%f | dist[0]=%f | dist[1]=%f \n", 
      line_sensor[0], line_sensor[1], dist_sensor[0], dist_sensor[1]);
    //printf("counter = %f    \n", counter);
    /*
    ...
    */
    ...
    if (dist_sensor[0] > ref){
      ...
      if (line_sensor[0] == 0 ||  line_sensor[1] == 0){
        ...
        speed[0] = 140; speed[1] = 140;
      }
    //}
    
    speed[0] = speed[0]/20; speed[1] = speed[1]/20;
